...
export const _android_ui_nested_quote_tweet_preview_enabled = false
...
export const _av_chat_group_e2ee_creator_enabled = false
export const _av_chat_group_e2ee_joiner_enabled = false
export const _av_chat_xchat_emoji_reactions_enabled = false
export const _birdwatch_xchat_pivot_rendering_enabled = true
...
export const _branded_features_search_overlay_animations_enabled = true
export const _branded_like_preview_enabled = false
export const _broadcast_live_chat_enabled = true
export const _broadcast_live_chat_input_max_char_limit = 200
...
export const _co_timeline_reset_period_minutes = 20
export const _co_timeline_topic_filter_enabled = false
...
export const _complat_management_enabled = false
export const _complat_responsive_web_castle_minting_enabled = false
export const _composer_add_geo_network_conversation_controls = true
export const _composer_composition_signals_enabled = true
export const _content_disclosure_ai_generated_c2pa_detection_enabled = true
...
export const _content_disclosure_c2pa_detection_exemption_list = ["Adobe Photoshop","Adobe Firefly","Canva AI"]
...
export const _grok_agent_disclosure_enabled = false
export const _grok_created_with_grok_label_domains = []
export const _grok_created_with_grok_label_text = ""
export const _grok_created_with_grok_label_url = ""
...
export const _grok_translations_community_note_auto_translation_is_enabled = false
export const _grok_translations_community_note_translation_is_enabled = false
export const _grok_translations_post_auto_translation_is_enabled = false
export const _grok_xweb_connectors_enabled = false
export const _grok_xweb_skills_enabled = false
...
export const _gryphon_upgrade_premium_plus_banner_enabled = true
...
export const _hometimeline_pinned_tabs_limit = 10
export const _hometimeline_pinned_tabs_management_pinnedsection_inline_limit = 3
export const _hometimeline_pinned_tabs_management_topics_inline_limit = 8
export const _hometimeline_pinned_tabs_topics_enabled = true
...
export const _immersive_video_status_linkable_timestamps = false
...
export const _jetfuel_forgot_password_migration_enabled = true
...
export const _media_async_upload_longer_video_max_video_size = 16384
...
export const _media_async_upload_max_video_duration = 1200
...
export const _new_timeline_experiment_enabled = false
export const _oauth_consent_account_switch_enabled = true
...
export const _payments_auth_token_enabled = true
export const _payments_business_onboarding_support = []
export const _payments_cash_deposits_enabled = true
export const _payments_chat_support_enabled = false
export const _payments_chat_support_for_limits_enabled = true
export const _payments_cheques_deposits_enabled = true
export const _payments_crb_iframe_delay_msecs = 1000
export const _payments_csv_export_enabled = false
export const _payments_forward_with_enabled = true
export const _payments_funds_insurance_redesign_enabled = true
export const _payments_funds_insurance_sweep_enabled = true
export const _payments_half_cover_notices_enabled = true
export const _payments_interest_details_with_boost_enabled = true
export const _payments_international_wires_enabled = false
export const _payments_lexical_search_enabled = false
export const _payments_onboarding_issued_cards_polling_enabled = true
export const _payments_passkey_onboarding_enabled = true
export const _payments_scheduled_payments_enabled = true
export const _payments_secondary_accounts_enabled = true
export const _payments_shared_accounts_enabled = true
export const _payments_support_grpc_enabled = true
export const _payments_support_xchat_sessions_enabled = true
export const _payments_timeline_action = true
export const _payments_tracing_reports_enabled = true
export const _payments_transaction_receipt_enabled = true
export const _payments_transaction_search_enabled = true
export const _payments_transfer_link_enabled = false
export const _payments_web_external_app_enabled = false
export const _people_search_interests_filter_enabled = false
export const _post_ctas_fetch_enabled = false
...
export const _premium_paywall_on_app_load_journey_enabled = true
export const _premium_paywall_on_app_load_min_account_age_days = 60
export const _premium_webview_paywall_custom_timelines_feature_enabled = true
...
export const _recruiting_admin_currencies_enabled = false
export const _recruiting_global_jobs_search_enabled = false
export const _recruiting_job_page_consumption_enabled = false
...
export const _recruiting_jobs_list_consumption_enabled = false
export const _recruiting_jobs_list_search_enabled = false
export const _recruiting_jobs_list_share_enabled = false
export const _recruiting_pin_job_enabled = false
export const _recruiting_premium_jobs_enabled = false
export const _recruiting_promoted_jobs_enabled = false
export const _recruiting_search_filters_enabled = false
export const _recruiting_verified_orgs_admin_enabled = false
export const _recruiting_verified_orgs_ats_integration_enabled = false
export const _recruiting_verified_orgs_enroll_allowed = false
...
export const _responsive_web_android_quick_promote_stripe_elements_enabled = false
...
export const _responsive_web_birdwatch_crowd_nmr_pivots_enabled = true
...
export const _responsive_web_birdwatch_media_history_enabled = false
...
export const _responsive_web_birdwatch_note_request_suggestion_enabled = true
...
export const _responsive_web_birdwatch_show_note_request_sources_despite_top_writer_status = false
...
export const _responsive_web_commerce_shop_spotlight_enabled = false
...
export const _responsive_web_gpc_enabled = true
...
export const _responsive_web_grok_article_summary_enabled = true
...
export const _responsive_web_grok_bio_auto_translation_in_followers_enabled = true
export const _responsive_web_grok_bio_auto_translation_in_search_is_enabled = true
export const _responsive_web_grok_bio_auto_translation_is_enabled = true
export const _responsive_web_grok_bot_preset_enabled = true
export const _responsive_web_grok_bot_preset_title = "create_a_bot"
export const _responsive_web_grok_build_tab_relabel_enabled = false
export const _responsive_web_grok_community_note_auto_translation_is_enabled = true
export const _responsive_web_grok_community_note_translation_is_enabled = true
...
export const _responsive_web_grok_download_cta_copy = "open_grok"
export const _responsive_web_grok_download_cta_enabled = true
export const _responsive_web_grok_download_favicons = true
export const _responsive_web_grok_edit_image_attribution_mode = "free"
...
export const _responsive_web_grok_imagine_banner_config = "{&quot;preset&quot;:&quot;bot&quot;}"
export const _responsive_web_grok_imagine_composer_enabled = false
export const _responsive_web_grok_imagine_continue_seamless_enabled = true
...
export const _responsive_web_grok_img_composer_in_media_picker = false
export const _responsive_web_grok_img_composer_redirect_to_grok_com_imagine = true
export const _responsive_web_grok_imggen_count = 4
export const _responsive_web_grok_inplace_auth_handoff_enabled = true
...
export const _responsive_web_grok_post_inline_translation_is_enabled = true
...
export const _responsive_web_grok_promo_modal_variant = "grok_4_5_launch"
...
export const _responsive_web_grok_show_grok_translated_post = true
export const _responsive_web_grok_show_message_post_button = true
export const _responsive_web_grok_sidebar_campaign_variant = ""
...
export const _responsive_web_grok_tweet_translation = true
...
export const _responsive_web_grok_xweb_link_prompt_cooldown_days = 2
export const _responsive_web_grok_xweb_link_required = false
export const _responsive_web_grok_xweb_linked_share_readonly_enabled = true
export const _responsive_web_grok_xweb_replacement_enabled = false
...
export const _responsive_web_history_screen_enabled = true
...
export const _responsive_web_jetfuel_add_phone_enabled = true
export const _responsive_web_jetfuel_enable_sms_2fa_enabled = true
...
export const _responsive_web_live_commerce_enabled = false
export const _responsive_web_live_scheduled_broadcast_countdown_enabled = false
export const _responsive_web_live_video_viewer_session_enabled = false
export const _responsive_web_livecut_native_share_enabled = true
...
export const _responsive_web_media_upload_appendmulti_enabled = true
export const _responsive_web_media_upload_appendmulti_max_concurrent_requests = 4
export const _responsive_web_media_upload_appendmulti_max_request_bytes = 25165824
export const _responsive_web_media_upload_appendmulti_max_segment_bytes = 8388608
export const _responsive_web_media_upload_appendmulti_min_file_bytes = 1048576
export const _responsive_web_media_upload_appendmulti_min_segment_bytes = 262144
export const _responsive_web_media_upload_appendmulti_pre_read_blob = false
export const _responsive_web_media_upload_appendmulti_target_wire_send_time_ms = 30000
export const _responsive_web_media_upload_host = "upload.x.com"
...
export const _responsive_web_native_bridge_allowed_methods = ["toast","slideshow"]
export const _responsive_web_native_emojis_enabled = true
export const _responsive_web_nested_quote_preview_enabled = false
export const _responsive_web_nfl_enabled = true
export const _responsive_web_nfl_game_dock_enabled = false
export const _responsive_web_nfl_hub_home_tab_enabled = true
export const _responsive_web_nfl_profile_sports_enabled = true
export const _responsive_web_nfl_sidebar_enabled = true
export const _responsive_web_nfl_sidebar_for_all_users_enabled = true
export const _responsive_web_nfl_sidebar_max_live_games = 3
export const _responsive_web_nfl_team_picker_enabled = true
...
export const _responsive_web_primary_nav_route_preload_enabled = false
...
export const _responsive_web_profile_redesign_enabled = true
export const _responsive_web_profile_redirect_enabled = true
...
export const _responsive_web_qp_ads_screening_dialog_enabled = false
export const _responsive_web_qp_boost_content_check_enabled = false
export const _responsive_web_qp_boost_content_check_min_delay_seconds = 0
export const _responsive_web_qp_budgets_by_billing_currency_enabled = false
export const _responsive_web_qp_full_popup_enabled = true
...
export const _responsive_web_qp_paused_policy_hint_enabled = true
export const _responsive_web_qp_paused_rejection_reasons_enabled = true
export const _responsive_web_qp_skip_objective_enabled = true
export const _responsive_web_qp_two_screens_enabled = true
export const _responsive_web_quick_promote_cta_enabled = true
export const _responsive_web_quick_promote_high_budget_tier_enabled = true
...
export const _responsive_web_scheduling_threads_enabled = true
...
export const _responsive_web_service_worker_update_toast_interval_hours = 0
...
export const _responsive_web_sports_live_profile_rings_enabled = true
...
export const _responsive_web_subscribers_ntab_for_creators_enabled = false
...
export const _responsive_web_tweet_drafts_threads_enabled = true
...
export const _responsive_web_twitter_article_table_enabled = true
...
export const _responsive_web_use_new_landing_page = true
export const _responsive_web_use_new_onboarding = true
...
export const _responsive_web_verified_organizations_application_requirements_enabled = false
...
export const _responsive_web_video_autoplay_bandwidth_threshold_enabled = true
...
export const _rweb_analytics_post_details_realtime_enabled = true
...
export const _rweb_cashtags_composer_attachment_enabled = true
export const _rweb_cashtags_composer_attachment_size_customization_enabled = true
export const _rweb_cashtags_composer_enabled = true
export const _rweb_cashtags_enabled = true
export const _rweb_client_transaction_id_enabled = true
export const _rweb_composer_emoji_typeahead_enabled = true
...
export const _rweb_home_jot_context_enabled = true
...
export const _rweb_media_carousel_enabled = true
export const _rweb_media_multi_requests_default_pool_size = 1
export const _rweb_media_multi_requests_enabled = true
export const _rweb_mixed_media_uploads_cap = 4
export const _rweb_modal_animation_enabled = true
export const _rweb_modal_animation_timing_function = "cubic-bezier(0.25, 0.1, 0.25, 1)"
export const _rweb_modal_composer_animation_enabled = true
export const _rweb_modal_overlay_color_dark = "rgba(0, 0, 0, 0.5)"
export const _rweb_modal_overlay_color_light = "rgba(180, 180, 182, 0.5)"
...
export const _rweb_promoted_tweet_max_text_lines = 2
export const _rweb_quick_promote_action_menu_enabled = true
export const _rweb_quick_promote_boost_enabled = false
export const _rweb_quick_promote_gold_verified_boost_enabled = true
export const _rweb_quick_promote_third_party_boost_enabled = true
...
export const _rweb_sports_post_context_enabled = true
export const _rweb_sports_post_context_footer_enabled = true
export const _rweb_sports_post_context_header_enabled = false
export const _rweb_ssp_ads_enabled = false
export const _rweb_ssp_ads_premium_bypass_enabled = false
export const _rweb_ssp_ads_refresh_enabled = false
export const _rweb_starter_packs_topics_tab_enabled = false
export const _rweb_timeline_simple_conversation_control_education_enabled = true
export const _rweb_tipjar_consumption_enabled = false
export const _rweb_tweets_boosting_enabled = false
export const _rweb_tweets_reply_context_hidden = true
export const _rweb_tweets_tweet_detail_font_size = "headline2"
export const _rweb_under_the_hood_report_enabled = true
export const _rweb_under_the_hood_report_jetfuel_enabled = true
...
export const _rweb_video_tagging_enabled = true
export const _rweb_xchat_bug_report_url = ""
export const _rweb_xchat_call_health_enabled = true
export const _rweb_xchat_call_link_enabled = false
export const _rweb_xchat_call_redirect_enabled = false
export const _rweb_xchat_call_window_enabled = false
export const _rweb_xchat_calls_rtc_api_enabled = true
export const _rweb_xchat_calls_v2_enabled = false
export const _rweb_xchat_calls_whiteboard_enabled = false
export const _rweb_xchat_client_stats_enabled = true
...
export const _rweb_xchat_loudness_control_enabled = false
export const _rweb_xchat_markdown_tables_enabled = false
export const _rweb_xchat_scroller_rewrite_enabled = true
...
export const _rweb_xchat_ws_only_when_active = false
...
export const _spaces_live_chat_enabled = false
...
export const _subscriptions_feature_organization_x_hiring = false
export const _subscriptions_feature_premium_insights = true
export const _subscriptions_feature_premium_jobs = false
...
export const _subscriptions_management_failed_payment_paywall_banner_enabled = true
...
export const _subscriptions_marketing_page_compare_table_ctas_enabled = false
...
export const _subscriptions_marketing_page_grok_4_web_paywall = false
...
export const _subscriptions_marketing_page_stripe_optimization_enabled = true
...
export const _subscriptions_offers_intro_title_new_copy_enabled = true
export const _subscriptions_offers_localized_pricing_enabled = false
export const _subscriptions_offers_paywall_urgent_heading_enabled = false
export const _subscriptions_offers_premium_nav_indicator_enabled = false
export const _subscriptions_offers_premium_nav_indicator_variant = ""
...
export const _subscriptions_premium_hub_boost_block_enabled = true
...
export const _subscriptions_upsells_articles_post_composer_promo_variant_enabled = false
export const _subscriptions_upsells_articles_profile_promo_variant_enabled = false
...
export const _subscriptions_upsells_edit_post_promo_variant_enabled = false
...
export const _subscriptions_upsells_highlights_profile_promo_variant_enabled = false
...
export const _subscriptions_upsells_post_limit_toast = true
...
export const _subscriptions_upsells_sidebar_default_promo_variant_enabled = false
export const _subscriptions_upsells_track_interactions_enabled = false
...
export const _subscriptions_upsells_visitor_get_verified_age_gate_enabled = true
...
export const _subscriptions_verified_to_premium_enabled = false
...
export const _timeline_scroll_pointer_events_optimization = false
...
export const _unified_cards_clip_long_media_aspect_ratio = 0.1
export const _unified_cards_clip_long_media_promoted_content_enabled = true
export const _unified_cards_destination_url_params_enabled = false
...
export const _unified_cards_force_show_cta_bar_card_types = []
...
export const _unified_cards_web_card_redesign_variant = "cta_bottom_bar"
...
export const _video_attribution_display_over_video_cards_enabled = true
...
export const _web_video_hlsjs_version = "1.6.0"
export const _web_video_persist_bandwidth_estimate_enabled = true
export const _web_video_persist_player_preferences_enabled = false
...
export const _x_android_apollo_graphql_accept_header = "application/json"
export const _x_android_apollo_graphql_accept_header_override = true
export const _x_jetfuel_enable_test_cluster = false
export const _x_jetfuel_use_new_api_url = true
export const _x_lite_quick_promote_analytics_banner_enabled = false
export const _x_sports_game_chat_should_hide_logos = false
export const _x_sports_nfl_favorite_teams_enabled = true
export const _x_sports_nfl_game_chat_enabled = true
export const _x_sports_nfl_game_chat_team_pick_enabled = true
export const _x_sports_nfl_game_feed_enabled = true
export const _x_sports_nfl_game_odds_card_enabled = true
export const _x_sports_nfl_game_player_props_enabled = false
export const _x_sports_nfl_game_roster_enabled = false
export const _x_sports_nfl_hub_home_timeline_tag = "1000000000000000005"
export const _x_sports_nfl_schedule_reminder_enabled = true
export const _x_sports_nfl_scorecard_odds_disabled = true
export const _x_sports_play_video_enabled = true
export const _x_sports_post_context_enabled = false
export const _x_sports_post_context_min_spacing = 3
export const _x_sports_post_context_same_game_min_spacing = 20
export const _xai_profile_redirect_enabled = true
export const _xcall_link_devices_enabled = false
export const _xchat_additional_reply_preview_validation_required_seqnum_str = "0"
export const _xchat_additional_reply_preview_validation_send = false
export const _xchat_ask_grok_enabled = true
export const _xchat_attachment_viewer_enabled = false
...
export const _xchat_batch_updates_for_bottom_cursor_processing = true
export const _xchat_ckey_recovery_enabled = false
export const _xchat_ckey_sig_v6_enforce_after_seq_num_str = "2082251782884425728"
export const _xchat_clear_chat_enabled = true
export const _xchat_composer_photo_editor_enabled = false
export const _xchat_conversation_event_limit = 200
export const _xchat_creator_group_syncing_enabled = false
export const _xchat_dm_media_upload_workmanager_enabled = false
export const _xchat_dm_write_gate_enabled = true
export const _xchat_drafts_bump_to_top = true
export const _xchat_drop_messages_failing_franking_verification = false
export const _xchat_drop_sigs_after_seq_num = 9223372036854776000
export const _xchat_drop_sigs_after_seq_num_str = "2055075687429046272"
...
export const _xchat_enable_command_menu = true
export const _xchat_enable_default_disappearing_messages_setting = false
export const _xchat_enable_default_screenshot_blocking_setting = false
...
export const _xchat_enable_franking_report = true
export const _xchat_enable_in_memory_event_retry = true
export const _xchat_enable_in_memory_event_retry_bottom_cursor = true
export const _xchat_enable_legacy_metadata_write = true
export const _xchat_enable_message_request_ui_v3 = true
export const _xchat_enable_message_requests = true
export const _xchat_enable_message_requests_attachments = false
export const _xchat_enable_metadata_sync = false
export const _xchat_enable_numbers = true
export const _xchat_enable_numbers_copying = true
export const _xchat_enable_numbers_generation = false
export const _xchat_enable_numbers_premium = false
export const _xchat_enable_ratcheting = false
export const _xchat_enable_reaction_notifs = false
export const _xchat_enable_realm_reach_check = false
export const _xchat_enable_share_message_v2 = false
export const _xchat_enable_single_message_locking = false
export const _xchat_enable_undecryptable_tombstones = false
export const _xchat_enable_user_metadata_migration_dry_run = false
export const _xchat_enable_video_autoplay = false
export const _xchat_enforce_media_hash_verification = false
export const _xchat_external_app_integrations_enabled = true
export const _xchat_fail_closed_unsigned_sends = true
export const _xchat_fetch_messages_from_push_handler = false
export const _xchat_forward_media_max_conversations = 5
export const _xchat_forward_media_max_size_mb = 100
export const _xchat_franking_required_after_seq_num = 9223372036854776000
export const _xchat_franking_required_after_seq_num_str = "9223372036854775807"
export const _xchat_grok_bots = false
export const _xchat_grok_bots_transcript_page_size = 50
export const _xchat_group_admin_settings_enabled = true
export const _xchat_group_description_enabled = true
export const _xchat_grpc_chat_page_enabled = false
export const _xchat_hide_pending_members_for_non_admin = true
export const _xchat_hybrid_pull_eagerly_fetch_history_after_seconds = -1
export const _xchat_inbox_checksum_scribing_enabled = true
export const _xchat_inbox_conversation_event_limit = 5
export const _xchat_inbox_conversation_limit = 20
export const _xchat_inbox_conversation_limit_subsequent = 100
export const _xchat_inbox_conversation_local_pagination_page_size = 20
export const _xchat_inbox_new_messages_preview_enabled = false
export const _xchat_invalid_sig_log_after_seq_num_str = "2082251782884425728"
export const _xchat_invoke_grok_bot_enabled = false
export const _xchat_ios_max_io_threads = 64
export const _xchat_keep_db_when_processing_inbox_response = false
export const _xchat_keypair_nuclear_reset_enabled = false
export const _xchat_keypair_recovery_enabled = false
export const _xchat_liquid_glass_convo_header_enabled = false
export const _xchat_local_pagination_page_size = 50
export const _xchat_long_messages_enabled = true
export const _xchat_markdown_rendering_enabled = true
export const _xchat_max_attachments_per_message = 10
export const _xchat_max_group_description_length = 500
export const _xchat_max_group_size = 1000
export const _xchat_max_group_size_for_live_read_receipts = 50
export const _xchat_max_group_size_for_remove_info_item = 100
export const _xchat_max_message_plaintext_length_bytes = "11000"
export const _xchat_max_message_preview_size = "1000"
export const _xchat_max_users_to_fetch_per_request = 100
export const _xchat_media_download_io_batching_enabled = true
export const _xchat_media_resolve_threshold_fast_network_bytes_str = "104857600"
export const _xchat_media_resolve_threshold_slow_network_bytes_str = "10485760"
export const _xchat_media_upload_io_batching_enabled = true
export const _xchat_message_composer_v2 = false
export const _xchat_message_date_tap_enabled = false
export const _xchat_message_grouping_window_seconds = 3600
export const _xchat_message_list_v2_enabled = false
export const _xchat_message_request_rate_limit_upsell = true
export const _xchat_missing_messages_scribe_enabled = false
export const _xchat_molecule_enabled = false
export const _xchat_numbers_tray_location = ""
export const _xchat_observe_inbox_categories_separately = true
export const _xchat_observe_inbox_users_enabled = true
export const _xchat_passcode_options_enabled = false
export const _xchat_pay_button_enabled = true
export const _xchat_pin_signatures_enabled = false
export const _xchat_pinned_messages_enabled = true
export const _xchat_pinned_messages_reading_enabled = true
export const _xchat_plaintext_grok_enabled = false
export const _xchat_plaintext_grok_minimum_tier = "PremiumPlus"
export const _xchat_pmk_bundle_signatures_enabled = false
export const _xchat_ratchet_group_id_threshold = 9223372036854776000
export const _xchat_ratchet_group_id_threshold_str = "9223372036854775807"
export const _xchat_realm_migration_local_key_fallback_enabled = false
export const _xchat_repair_groups_after_passcode_reset = true
export const _xchat_resolve_unencrypted_media_locally = true
...
export const _xchat_self_custody_enabled = false
export const _xchat_send_franking_data = true
export const _xchat_send_signature_protocol_version = 7
export const _xchat_separate_reactions_table_enabled = false
export const _xchat_settings_enabled = false
export const _xchat_settings_redesign_enabled = false
export const _xchat_share_to_ig_story = false
export const _xchat_signature_required_after_seq_num_str = "9223372036854775806"
export const _xchat_standalone_push_notifications = false
export const _xchat_streamed_link_preview = true
export const _xchat_swipe_to_reveal_timestamp_enabled = false
export const _xchat_throttle_badge_counts = false
export const _xchat_unread_mismatch_scribing_enabled = true
export const _xchat_url_preview_v2_enabled = true
export const _xchat_user_event_limit = 500
export const _xchat_validate_priv_pub_on_load = false
export const _xchat_voice_messages_enabled = true
export const _xchat_voice_messages_transcription_enabled = false
