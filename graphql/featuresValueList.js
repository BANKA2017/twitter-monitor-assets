...
export const _c9s_timelines_default_selection = "latest"
export const _c9s_timelines_media_tab_enabled = true
export const _c9s_timelines_top_latest_stickiness_enabled = false
export const _c9s_tweet_anatomy_moderator_badge_enabled = true
export const _card_detail_compact_enabled = true
export const _communities_enable_explore_tab = false
export const _communities_enable_explore_topic_carousel = false
export const _communities_show_broadcast_option_in_composer = true
export const _communities_topic_carousel_enabled = false
...
export const _creator_monetization_settings_revamp = true
...
export const _explore_graphql_enabled = false
...
export const _responsive_web_grok_prompt_deeplink_enabled = false
export const _responsive_web_grok_share_enabled = false
...
export const _responsive_web_trends_ui_top_articles = false
...
export const _responsive_web_twitter_article_cover_aspect_ratio_5_2 = true
...
export const _responsive_web_verified_organizations_full_access_annual_enabled = true
...
export const _rweb_live_broadcast_rewind_enabled = false
export const _rweb_master_detail_enabled = false
export const _rweb_media_carousel_enabled = false
export const _rweb_meetings_enabled = false
...
export const _settings_revamp_search_bar_enabled = false
...
export const _subscriptions_feature_can_hide_checkmark = true
...
export const _subscriptions_marketing_page_redesign_enabled = false
...
export const _subscriptions_premium_tiers_marketing_page_enabled = true
...
export const _tweet_limited_actions_config_community_tweet_member = ["embed","pin_to_profile","retweet","highlight"]
...
export const _tweet_limited_actions_config_community_tweet_non_member = ["embed","like","pin_to_profile","react","reply","reply_down_vote","retweet","share_tweet_via","vote_on_poll","highlight"]
export const _tweet_limited_actions_config_community_tweet_non_member_closed_community = ["embed","pin_to_profile","react","reply","reply_down_vote","retweet","vote_on_poll","highlight"]
export const _tweet_limited_actions_config_community_tweet_non_member_public_community = ["embed","pin_to_profile","react","reply","reply_down_vote","retweet","vote_on_poll","highlight"]
...
export const _twitter_delegate_enabled = false
...
export const _voice_rooms_web_space_creation = false
export const _web_image_large_webp_variants = false
export const _web_video_bitrate_persistence_enabled = true
