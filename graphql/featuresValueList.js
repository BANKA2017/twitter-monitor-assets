...
export const _xchat_discard_events_with_invalid_signature = true
...
export const _xchat_sign_graphql_messages = true
export const _xchat_sign_messages = true
export const _xchat_throttle_badge_counts = false
export const _xchat_user_event_limit = 500
export const _xchat_verify_message_signatures = true
